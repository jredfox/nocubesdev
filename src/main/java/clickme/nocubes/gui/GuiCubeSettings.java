...
public class GuiCubeSettings extends GuiScreen
{
    ...
    public void drawScreen(final int i, final int j, final float f)
    {
        ...
        this.drawCenteredString(this.fontRenderer, "No Cubes Settings", this.width / 2, this.height / 2 - 60, 16777215);
        this.drawCenteredString(this.fontRenderer, "(overrides all other options)", this.width / 2, this.height / 2 - 5, 16777215);
